        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class='modal-title' id='modalSejarah'>Edit Profil</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="javascript:void(0)" id="profilform" name="profilform" class="form-horizontal" method="POST" enctype="multipart/form-data">
                            ...
                            <label for="Gambar" class="col-form-label">Gambar</label>
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="image-profil" aria-describedby="image-profil" name="image" accept="image/*">
